...
namespace Commands {
	...
	void SendToJsonServiceCommand::SetRenderers(std::vector<std::shared_ptr<Renderers::IRenderer>> const renderers)
	{
		m_renderers = renderers;
	}

	void SendToJsonServiceCommand::SetConfigs(std::shared_ptr<Services::ConfigEntity> const configs)
	{
		m_configs = configs;
	}
