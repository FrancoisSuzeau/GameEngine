...
uniform sampler2D light_textures[30];
...
{    
    ...
    vec4 objectTexture2 = texture(component.texture_height1, fs_in.TexCoords);
    vec4 objectTexture3 = texture(component.texture_normal1, fs_in.TexCoords);
    vec4 objectTexture4 = texture(component.texture_specular1, fs_in.TexCoords);
