...
namespace Component
{
	...
	public:
		...
		static void Move(std::shared_ptr<Renderers::IRenderer> renderer);
		static void Resize(std::shared_ptr<Renderers::IRenderer> renderer);
		static void Rotate(std::shared_ptr<Renderers::IRenderer> renderer, glm::vec3 axis);
