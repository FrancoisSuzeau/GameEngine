...
namespace Renderers {
	SquareTextured::SquareTextured() : base(), m_bytes_textcoord_size(0)
	{
	...
	void SquareTextured::Draw(unsigned int const texture_id, std::vector<unsigned int> light_texture_ids)
	{
